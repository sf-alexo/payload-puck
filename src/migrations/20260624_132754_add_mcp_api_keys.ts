...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  `)
  await db.run(sql`INSERT INTO \`__new_payload_locked_documents_rels\`("id", "order", "parent_id", "path", "users_id", "media_id", "pages_id", "case_studies_id", "testimonials_id", "project_types_id", "industries_id", "techstacks_id") SELECT "id", "order", "parent_id", "path", "users_id", "media_id", "pages_id", "case_studies_id", "testimonials_id", "project_types_id", "industries_id", "techstacks_id" FROM \`payload_locked_documents_rels\`;`)
